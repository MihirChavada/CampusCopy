    ...
    <div class="container">
        ...
        <table class="table table-bordered m-2">
            ...
            <tbody>
                ...
                <button type="submit" onclick="openpdf()" class="btn btn-primary">view</button>
                </form> <?php echo "</td>";
                ...
                echo "<td>";  ?><a href="delete.php?token=<?php echo  $row["token"]; ?> <button type="button" class="btn btn-danger">delete</button></a>  <?php echo "</td>";                                                                                                                                        echo "</tr>";
                                                                                                                                                        }
                                                                                                                                                            ?>
                <script>
